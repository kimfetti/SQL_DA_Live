...
- A .sql file to compile the database for this course, [learning_platform](learning_platform.sql)
- A [database diagram](learning_platform_diagram.pdf) to visualize the learning_platform database
...
Kimberly Fessel, [Dr Kim Data](https://www.drkimdata.com)
